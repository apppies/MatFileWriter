...
var matFileWriter_exports = {};
__export(matFileWriter_exports, {
  MatFileWriter: () => MatFileWriter
});
module.exports = __toCommonJS(matFileWriter_exports);
...
var MatFileWriter = class {
  ...
  createZippedArray(variable) {
    ...
    const zipped = (0, import_fflate.zlibSync)(combined, { level: 6 });
    let tag = new Uint32Array(2);
